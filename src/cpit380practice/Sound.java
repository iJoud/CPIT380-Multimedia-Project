...
public class Sound extends SimpleSound
{
 ...
 FloatControl fc;
  public Sound(String fileName)
  {
    ...
    super(fileName);
//    FileChooser.setMediaPath("C:\\Users\\Win10\\Desktop\\CPIT 380"
//        + "\\From Dr.Meada\\LAB For Student-20200912T195806Z-001\\LAB For Student"
//        + "\\MediaSources\\");
  }
  ...
  public Sound (Sound copySound)
  {
   ...
   public Sound Squeeze() {
        ...
        SoundSample[] sampleSpreaded = this.getSamples();
...
//  }
  ...
  public void blendSounds() {
    ...
    for (int index = 0; index < 10000; index++) {
      value = (int) ((sound1.getSampleValueAt(index + 5000) * 
                      0.5) +
                     (sound2.getSampleValueAt(index) * 0.5));
      this.setSampleValueAt(index + 5000,value);
    }

    // copy the next 20,000 samples from sound2 into the target
    for (int index=10000; index < 20000; index++)
      this.setSampleValueAt(index + 15000,
                              sound2.getSampleValueAt(index));
  }
...
//  }
    ...
    public void setFc(double volume) {
